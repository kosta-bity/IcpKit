...
enum CandidSerialisationTestVectors {
    static let singleValueTestVectors: [(CandidValue, [UInt8])] = [
        ...
        (try! .service([CandidService.Method("foo", [.text], [.natural])], "w7x7r-cok77-xa"), [0x02, 0x6a, 0x01, 0x71, 0x01, 0x7d, 0x00, 0x69, 0x01, 0x03] + foo + [0x00, 0x01, 0x01, 0x01, 0x03, 0xca, 0xff, 0xee]),
        (try! .service([CandidService.Method("foo", [.text], [.natural]), CandidService.Method("foo2", [.text], [.natural])], "w7x7r-cok77-xa"), [0x02, 0x6a, 0x01, 0x71, 0x01, 0x7d, 0x00, 0x69, 0x02, 0x03] + foo +  [0x00, 0x04] + foo + [0x32, 0x00, 0x01, 0x01, 0x01, 0x03, 0xca, 0xff, 0xee]),
    ]
