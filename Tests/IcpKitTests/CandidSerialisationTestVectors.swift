...
enum CandidSerialisationTestVectors {
    static let singleValueTestVectors: [(CandidValue, [UInt8])] = [
        ...
        (try! .function([.principal], [.natural], "w7x7r-cok77-xa", "foo"), [0x01, 0x6a, 0x01, 0x68, 0x01, 0x7d, 0x00, 0x01, 0x00, 0x01, 0x01, 0x03, 0xca, 0xff, 0xee, 0x03] + Data("foo".utf8).bytes),
        (try! .function([.text], [.natural], query: true, "w7x7r-cok77-xa", "foo"), [0x01, 0x6a, 0x01, 0x71, 0x01, 0x7d, 0x01, 0x01, 0x01, 0x00, 0x01, 0x01, 0x03, 0xca, 0xff, 0xee, 0x03] + Data("foo".utf8).bytes),
        (try! .function([.text], [.natural], compositeQuery: true, "w7x7r-cok77-xa", "foo"), [0x01, 0x6a, 0x01, 0x71, 0x01, 0x7d, 0x01, 0x03, 0x01, 0x00, 0x01, 0x01, 0x03, 0xca, 0xff, 0xee, 0x03] + Data("foo".utf8).bytes),
    ]
