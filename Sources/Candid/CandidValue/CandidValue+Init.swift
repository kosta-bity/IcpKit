...
public extension CandidValue {
    ...
    static func function(_ inputs: [CandidType], _ outputs: [CandidType], query: Bool = false, oneWay: Bool = false, compositeQuery: Bool = false) -> CandidValue {
        .function(CandidFunction(
            signature: CandidFunctionSignature(inputs, outputs, query: query, oneWay: oneWay, compositeQuery: compositeQuery),
            method: nil
        ))
    }
    
    static func function(_ inputs: [CandidType], _ outputs: [CandidType], query: Bool = false, oneWay: Bool = false, compositeQuery: Bool = false, _ principal: CandidPrincipal, _ methodName: String) -> CandidValue {
        .function(CandidFunction(
            signature: CandidFunctionSignature(inputs, outputs, query: query, oneWay: oneWay, compositeQuery: compositeQuery),
            method: .init(name: methodName, principal: principal)
        ))
    }
    ...
    static func function(_ inputs: [CandidType] = [], _ outputs: [CandidType] = [], query: Bool = false, oneWay: Bool = false, compositeQuery: Bool = false, _ principal: String, _ methodName: String) throws -> CandidValue {
        .function(CandidFunction(
            signature: CandidFunctionSignature(inputs, outputs, query: query, oneWay: oneWay, compositeQuery: compositeQuery),
            method: try .init(name: methodName, principal: principal)
        ))
    }
    ...
    static func service(_ methods: [CandidServiceSignature.Method] = [], _ principal: CandidPrincipal) -> CandidValue {
        .service(CandidService(
            principal: principal,
            signature: CandidServiceSignature(methods)
        ))
    }
    
    static func service(_ methods: [CandidServiceSignature.Method], _ principal: String) throws -> CandidValue {
        .service(methods, try CandidPrincipal(principal))
    }
